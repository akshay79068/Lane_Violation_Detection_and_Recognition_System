...
A Flask application to run the YOLOv11 model on a video file or ip cam stream
...
app.config['SECRET_KEY'] = 'lane_violation_detection'
...
def generate_processed_frames(conf_):
...
def submit_form():
    ...
    if request.method == "POST":
        ...
        if 'download_button' in request.form:
            ...
            # os.system('del static/reports/detections_summary.txt')
            # os.system('cp number_plate.txt static/reports/detections_summary.txt')
